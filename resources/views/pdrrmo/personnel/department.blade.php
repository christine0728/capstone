              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card" style="width: 105%;">
                  <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalRelatedContent">New Department</button>
                    <p></p>
                    List of Department
                    </p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <form action="/pdrrmo/insert-department" method="post">
                            @csrf
 ...
 function confirmDelete(id) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          type: 'POST',
         url: '/pdrrmo/destroy-department/' + id,  
          data: {
            _token: '{{ csrf_token() }}',
            _method: 'DELETE'
          },
  ...
  $(document).on('click', '.btn-edit', function() {
    ...
    $.ajax({
    type: 'GET',
    url: '/pdrrmo/get-department/' + id,// Replace '/get-record/' with the correct URL from your routes file
    dataType: 'json',
    success: function(response) {
...
<div class="modal fade right" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="true">
  <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-danger" role="document">
    ...
    <div class="modal-content">
      <!--Header-->
      <div class="modal-header btn-primary text-white">
        <h4 class="modal-title">Update Deparment</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true" class="white-text">&times;</span>
        </button>
      </div>
      <form action="/pdrrmo/update-department" method="post" >
           <div class="modal-body">
                  @csrf
            <div class="form-group">
