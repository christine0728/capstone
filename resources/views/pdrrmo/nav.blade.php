    ...
    <li class="dropdown {{ request()->is('pdrrmo/receive-assistance') ? 'active' : '' }}">
        <a href="#pageSubmenu6" style="color: white;" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
            <i class="material-icons" style="color:white">support_agent</i><span>&nbsp;&nbsp;&nbsp;Assistance Request</span>
        </a>
   ...
   <a href="/pdrrmo/sitrepsub" style="color: white;">     <i class="material-icons" style="color: white;">note</i>&nbsp;&nbsp;&nbsp; Subjects</a>
        </li>
    </ul>
</li>
    ...
    <li class="dropdown">
                ...
                <li class="{{ request()->is('pdrrmo/Schedule-table') ? 'active' : '' }}">
                    <a href="/pdrrmo/Schedule-table" style="color: white;"> <i class="material-icons" style="color: white;">schedule</i>&nbsp;&nbsp;&nbsp;List of schedules</a>
                </li>
