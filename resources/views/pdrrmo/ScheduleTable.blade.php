...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/pdrrmo/filter-event" method="GET" class="form-inline">
                      ...
                      <a href="/pdrrmo/Schedule-table" class="btn btn-secondary">All</a>
                  </form>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
  ...
  $(document).on('click', '.btn-edit', function() {
    ...
    $.ajax({
    type: 'GET',
     url: '/pdrrmo/get-sched/' + id, // Replace '/get-record/' with the correct URL from your routes file
    dataType: 'json',
    success: function(response) {
      var participantsObj;
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="form-group">
            ...
            <label for="location" style="font-weight: bold;">Attendee:</label>
            <div class="form-group">
