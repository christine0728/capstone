...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card" style="width: 105%;">
                <div class="card-body">
                  <h3>Received Assistance</h3><br>
                  <p class="card-description">
                    List of Request
                    
                  </p>
                
                  <form action="/pdrrmo/filter-req" method="get" class="form-inline">
                      ...
                      <a href="/pdrrmo/receive-assistance" class="btn btn-secondary">All</a>
                  </form> <br>
...
<div class="modal fade" id="modalStatus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="true">
  <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-danger" role="document">
    ...
    <div class="modal-content">
      ...
      <!-- Body -->
      <form action="/pdrrmo/update-receive-assistance" method="post" onsubmit="return validateForm()">
        <div class="modal-body">
          @csrf
...
<script type="text/javascript">
  $(document).on('click', '.btn-history', function() {
    ...
    $.ajax({
        type: 'GET',
        url: '/pdrrmo/get-referral-history/' + requestId,
        dataType: 'json',
...
<script>
  $(document).on('click', '.btn-edit', function() {
    ...
    $.ajax({
    type: 'GET',
    url: '/pdrrmo/get-request/' + id,// Replace '/get-record/' with the correct URL from your routes file
    dataType: 'json',
    success: function(response) {
        ...
        var formattedDate = response.update_req_status
            ...
            $('#sevLabel').text(response.severity_name);
  
            $('#Respond').text(response.comment);
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-12">
          <div class="form-group">
              <label for="owner" style="font-weight: bold;">Requested by:</label>
            ...
            <div class="form-group">
              <label for="stat-update" style="font-weight: bold;">Date response:</label>
              <label id="stat-update"></label>
            </div>
            <div class="form-group">
              <label for ="Respond" style="font-weight: bold;">Message:</label>
              <label id="Respond"></label>
            </div>
