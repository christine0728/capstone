...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card" style="width: 105%;">
                <div class="card-body">
                  <h3>Manage Subjects for Situanal Reports</h3><br>
                         List of Subject
                  </p>
              ...
              <tbody>
                 ...
                 <tr style="{{ $notificationId == $subject->id ? 'background-color: #8fd3f3;' : '' }}">
            
                  <td>{{ $subject->subject}}</td>
                  <td>{{ $subject->description}}</td>
                  <td>{{ date('F d, Y g:ia', strtotime($subject->created_at )) }}</td>
                  <td>
                  <span style="{{ $subject->finalized_at ? 'color: red;' : 'color: black;' }}">
                      {{ $subject->finalized_at ? 'Finalized' : 'Not yet finalized' }}
                  </span>
                  </td>

                  <td style="{{ $subject->sitrepExists ? 'color: black;' : 'color: red;' }}">
                      {{ $subject->sitrepExists ? 'Sitrep Submitted' : 'Sitrep Not Submitted' }}
                  </td>
                    ...
                    <div class="col-12">
                        <form action="/pdrrmo/insert-subject" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="subject" class="form-control" placeholder="Enter subject" autocomplete="off" value="{{ old('subject') }}">
                                @error('name')
