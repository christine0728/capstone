...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card" style="width: 105%">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#modalRelatedContent">New Personnel</button>  </p>    List of Personnel
                  </p>
                  <form action="/mdrrmo/filter-personnel" method="get" class="form-inline">
                      ...
                      <a href="/mdrrmo/personnel" class="btn btn-secondary">All</a>
                  </form> <br>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> 
                     ...
                     <a href="#"  class="btn-edit btn btn-success btn-xs btn-sm" data-toggle="modal"  data-id="{{ $personnel->id }}" data-target="#modalEdit" ><i class="fas fa-edit" style="color:white"></i></a>
                     <a href="#"class="btn btn-danger btn-xs btn-sm" onclick="confirmDelete('{{ $personnel->id }}')"><i style="color: white;" class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
                @empty
                <tr>
...
if (result.isConfirmed) {
  ...
  $.ajax({
    type: 'POST',
   url: '/mdrrmo/destroy-personnel/' + id,   
    data: {
      _token: '{{ csrf_token() }}',
      _method: 'DELETE'
    },
...
$.ajax({
type: 'GET',
url: '/mdrrmo/get-personnel/' + id, // Replace '/get-record/' with the correct URL from your routes file
dataType: 'json',
success: function(response) {
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="updatePersonnelModalLabel">Update Personnel</h5>
            ...
            <div class="modal-body">
                ...
                <form action="/mdrrmo/update-personnel" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="emergency_contact_name" id="emergency_contact_name" class="form-control" placeholder="Enter Emergency Contact Name" autocomplete="off" value="{{ old('emergency_contact_name') }}">
...
<div class="modal fade right" id= "modalRelatedContent" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="true">
    <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-danger" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/mdrrmo/insert-personnel" method="post">
                    @csrf
                    <input type="hidden" name="id" id="id" value="{{ old('id') }}">
                    <div class="form-group">
...
<br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="contact_number" id="contact_number" class="form-control" placeholder="Enter Contact Number" autocomplete="off" value="{{old('contact_number')}}" required>
                        @error('contact_number')
                        <div class="text-sm" style="color: red;">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control" placeholder="Enter Email" autocomplete="off" value="{{old('email')}}" required>
                        @error('email')
                        <div class="text-sm" style="color: red;">{{ $message }}</div>
...
<br>
                    ...
                    <div class="form-group">
                        <label class="req-label">Emergency Contact number</label>
                        <input type="text" name="emergency_contact_name" id="emergency_contact_name" class="form-control" placeholder="Enter contact number" autocomplete="off" value="{{old('emergency_contact_name')}}">
                        @error('emergency_contact_name')
                        <div class="text-sm" style="color: red;">{{ $message }}</div>
