...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card" style="width: 105%">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalRelatedContent">New Positions</button> <p></p>    List of Positions
                  </p>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-12" style="margin: 20px;">
            <form action="/mdrrmo/insert-position" method="post">
              @csrf
              <div class="form-group">
                <label class="req-label">Position Name</label>
                <input type="text" name="position" class="form-control col-md-11" placeholder="Enter position" autocomplete="off" value="{{ old('position') }}">
                @error('position')
              ...
              <div class="form-group">
                ...
                <input type="text" name="description" class="form-control col-md-11" placeholder="Enter position description" autocomplete="off" value="{{ old('description') }}">
                @error('description')
                <div class="text-danger">{{ $message }}</div>
                @enderror
              </div>
 ...
 function confirmDelete(id) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          type: 'POST',
         url: '/mdrrmo/destroy-position/' + id,  
          data: {
            _token: '{{ csrf_token() }}',
            _method: 'DELETE'
          },
  ...
  $(document).on('click', '.btn-edit', function() {
    ...
    $.ajax({
    type: 'GET',
    url: '/mdrrmo/get-position/' + id,// Replace '/get-record/' with the correct URL from your routes file
    dataType: 'json',
    success: function(response) {
...
<div class="modal fade right" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="true">
  <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-danger" role="document">
    ...
    <div class="modal-content">
      ...
      <form action="/mdrrmo/update-position" method="post">
        <div class="modal-body">
          @csrf
          <div class="form-group">
            <label class="req-label">Position Name</label>
          ...
          <div class="form-group">
            <label class="req-label">Description</label>
            <input type="text" name="update-desc" id="update-desc" class="form-control" placeholder="Enter position description" autocomplete="off" value="">
            @error('update-desc')
            <div class="text-red-600 text-sm">{{ $message }}</div>
            @enderror
          </div>
