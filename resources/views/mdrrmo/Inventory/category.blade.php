...
<div class="col-lg-12 grid-margin stretch-card">
              ...
              <tbody>
               ...
               <tr>
                  <td>{{ $category->name }}</td>
                  <td> 
                  <a href="#" class="btn-edit" data-toggle="modal"  data-id="{{ $category->id }}" data-target="#modalEdit" ><i style="color:green" class="fa fa-edit"></i></a>
                  <a href="#" onclick="confirmDelete('{{ $category->id }}')"><i style="color:RED;" class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
                @empty
                <tr>
  ...
  <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-info" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-12">
            <form action="/mdrrmo/insert-category" method="post">
              @csrf
              <div class="form-group">
                <label class="req-label">Category Name</label>
                <input type="text" name="cat-name" class="form-control" placeholder="Enter category name" value="{{ old('cat-name') }}">
                @error('cat-name')
