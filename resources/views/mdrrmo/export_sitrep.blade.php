...
<button  style="text-decoration: none; padding: 10px 15px; font-size: 16px; background-color: #3498db; color: #fff; border-radius: 4px; display: inline-block; margin-top: 20px;" onclick="Export2Word('exportContent', 'word-content.docx');"  style="text-decoration: none; padding: 10px 15px; font-size: 16px; background-color: #3498db; color: #fff; border-radius: 4px; display: inline-block; margin-top: 20px;">Export as .docx</button>
